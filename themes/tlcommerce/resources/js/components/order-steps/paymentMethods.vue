  ...
  <div class="shadow-card mb-30">
    <div class="row" v-if="!loading">
      ...
      <div class="col-12 mb-20">
        <div class="term-wrapper d-flex align-items-center gap-2">
          <input type="checkbox" id="term" v-model="term_condition_agreement" />
          <label class="checkmark" for="term">
            <span>
              {{ $t("I have read and agree to the ") }}
            </span>
            <router-link
              :to="`/page/${config.customer_checkout_term_condition_page_slug}`"
              target="_blank"
              class="c1"
            >
        ...
        <p class="fz-12 text-danger mt-1" v-if="term_condition_agreement_error">
  ...
  methods: {
    ...
    createOrder() {
      ...
      if (!this.term_condition_agreement) {
        this.$toast.error(this.$t("Check terms and conditions"));
