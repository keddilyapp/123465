            ...
            <div class="widget_wrap" :class="{ active: wToggle }">
              ...
              <div class="widget_wrap-inner">
                <WidgetTopCategory
                  ...
                  :selected-cat-id="category_filter_id"
                ...
                <WidgetBrand
                  ...
                  :selected-brand-id="brand_filter_id"
                ...
                <WidgetPrice
                  ...
                  :selected-range="selected_price_range"
              ...
              <div class="col-12">
                <div class="mb-40 shadow-card">
                  ...
                  <div
                    ...
                    v-if="
                      brand_filter.id != null ||
                      category_filter.id != null ||
                      price_filter.min != null ||
                      rating_filter != null
                    "
                  >
                    <div class="filter-tags">
                      ...
                      <div class="ant-tag" v-if="brand_filter.id != null">
                      ...
                      <div class="ant-tag" v-if="category_filter.id != null">
                        <span class="ant-tag-text">{{
                      ...
                      <div class="ant-tag" v-if="price_filter.min != null">
                        <span class="ant-tag-text">
                          <the-currency
